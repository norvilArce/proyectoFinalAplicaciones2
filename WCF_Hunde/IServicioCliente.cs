...
namespace WCF_Hunde
{
    ...
    {
        [OperationContract]
        ClienteBE ConsultCliente(String strCod);

        [OperationContract]
        Boolean InsertCliente(ClienteBE objClienteBE);

        [OperationContract]
        Boolean UpdateCliente(ClienteBE objClienteBE);

        [OperationContract]
        Boolean DeleteCliente(String strCod);

        [OperationContract]
        List<ClienteBE> GetAllCliente();
    }
